                ...
                <header className="grid grid-cols-6 md:grid-cols-12 md:gap-4 gap-0 h-[80px] items-center px-4">
                    ...
                    <div className="md:col-span-8 col-span-0">
                        ...
                        <nav className={`md:hidden ${isMenuOpen ? 'block' : 'hidden'} absolute top-16 left-0 bg-white w-full shadow-lg`}>
                            <a href="/" className="block px-4 py-2 text-blue-500 hover:text-blue-700">
                                <span className="font-normal font-sans text-[14px]">Home</span>
                            </a>
                    ...
                    <div className="md:col-span-2 col-span-3">
                        <div className="flex space-x-4 justify-end">
                            {/* Icons */}
                            <svg
                                className="w-6 h-6" // Show only on medium and larger screens, with size adjustments
                                width="24"
                                height="24"
                                viewBox="0 0 24 24"
                                fill="none"
                            ...
                            {/* Mobile menu icon */}
                            <svg
                                className="md:hidden w-6 h-6" // Show only on small screens, with size adjustments
                                width="24"
                                height="24"
                                viewBox="0 0 24 24"
                                fill="none"
